package com.zhishulian.auth.service;
...
//            ExceptionCast.cast(AuthCode.AUTH_LOGIN_TOKEN_SAVEFAIL);
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        String authUrl = uri+ "/auth/oauth/token";//这个地址Spring Security来自己实现的
        //定义header
        LinkedMultiValueMap<String, String> header = new LinkedMultiValueMap<>();
        String httpBasic = getHttpBasic(clientId, clientSecret);
        header.add("Authorization",httpBasic);//使用Base
        ...
        if(bodyMap == null ||
            ...
            if(StringUtils.isNotEmpty(errorDescription)){
                ...
                }else if(errorDescription.indexOf("UserDetailsService returned null")>=0){
